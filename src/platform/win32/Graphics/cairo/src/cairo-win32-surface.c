...
cairo_win32_surface_create (HDC hdc)
{
    ...
    /* HUMANIZED EDIT: Commented out the following lines querying
     * BITSPIXEL and set the pixel format to CAIRO_FORMAT_ARGB32,
     * because that's what TransparentWindow's underlying bitmap
     * (which will be the selected object of this hdc) always uses
     * internally, regardless of the color depth of the actual
     * screen. -Atul */
