...
class TransparentWindowError(_object):
    ...
    def what(*args): return _TransparentWindow.TransparentWindowError_what(*args)
...
class TransparentWindow(_object):
    ...
    __del__ = lambda self : None;
    def update(*args): return _TransparentWindow.TransparentWindow_update(*args)
    def hideWindow(*args): return _TransparentWindow.TransparentWindow_hideWindow(*args)
    def setOpacity(*args): return _TransparentWindow.TransparentWindow_setOpacity(*args)
    def getOpacity(*args): return _TransparentWindow.TransparentWindow_getOpacity(*args)
    def setPosition(*args): return _TransparentWindow.TransparentWindow_setPosition(*args)
    def getX(*args): return _TransparentWindow.TransparentWindow_getX(*args)
    def getY(*args): return _TransparentWindow.TransparentWindow_getY(*args)
    def setSize(*args): return _TransparentWindow.TransparentWindow_setSize(*args)
    def getWidth(*args): return _TransparentWindow.TransparentWindow_getWidth(*args)
    def getHeight(*args): return _TransparentWindow.TransparentWindow_getHeight(*args)
    def getMaxWidth(*args): return _TransparentWindow.TransparentWindow_getMaxWidth(*args)
    def getMaxHeight(*args): return _TransparentWindow.TransparentWindow_getMaxHeight(*args)
    def makeCairoSurface(*args): return _TransparentWindow.TransparentWindow_makeCairoSurface(*args)
